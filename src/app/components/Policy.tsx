    ...
    <main>
      <div className="mx-auto max-w-3xl px-4 py-16">
        ...
        <div className="text-gray-700 mb-6">
          <h2 className="text-primary text-lg mb-2">Information We Collect</h2>
          <p>
        ...
        <div className="text-gray-700 mb-6">
          <h2 className="text-primary text-lg mb-2">Information Sharing</h2>
          <p>
        ...
        <div className="text-gray-700 mb-6">
          <h2 className="text-primary text-lg mb-2">Data Security</h2>
          <p>
        ...
        <div className="text-gray-700 mb-6">
          <h2 className="text-primary text-lg mb-2">Your Rights</h2>
          <p>
